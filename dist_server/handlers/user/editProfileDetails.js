...
export default async function editProfileDetails(req, res) {
    try {
...
function validateNewProfileDetails(newProfileDetails) {
...
function isInformationValid(validationObject) {
    const result = Object.values(validationObject).find(e => e === false);
    return result ? false : true;
}
//# sourceMappingURL=editProfileDetails.js.map